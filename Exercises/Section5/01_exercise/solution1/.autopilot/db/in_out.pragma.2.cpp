# 1 "punto1/.settings/in_out.cpp"
# 1 "punto1/.settings/in_out.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "punto1/.settings/in_out.cpp" 2

void in_out(unsigned short int input, unsigned short int *output){
_ssdm_op_SpecInterface(output, "ap_none", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(0, "ap_ctrl_none", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(input, "ap_none", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
