...
// ==============================================================
#ifndef __inOutFunction_sredEe__HH__
#define __inOutFunction_sredEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inOutFunction_sredEe) {
    ...
    SC_CTOR(inOutFunction_sredEe):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
