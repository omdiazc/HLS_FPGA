...
// ==============================================================
#ifndef __inOutFunction_srecud__HH__
#define __inOutFunction_srecud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inOutFunction_srecud) {
    ...
    SC_CTOR(inOutFunction_srecud):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
