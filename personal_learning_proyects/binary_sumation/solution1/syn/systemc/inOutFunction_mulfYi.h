...
// ==============================================================
#ifndef __inOutFunction_mulfYi__HH__
#define __inOutFunction_mulfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inOutFunction_mulfYi) {
    ...
    SC_CTOR(inOutFunction_mulfYi):  ACMP_smul_us_U ("ACMP_smul_us_U") {
