...
// ==============================================================
#ifndef __inOutFunction_sreeOg__HH__
#define __inOutFunction_sreeOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inOutFunction_sreeOg) {
    ...
    SC_CTOR(inOutFunction_sreeOg):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
