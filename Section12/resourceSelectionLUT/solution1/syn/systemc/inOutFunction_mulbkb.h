...
// ==============================================================
#ifndef __inOutFunction_mulbkb__HH__
#define __inOutFunction_mulbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inOutFunction_mulbkb) {
    ...
    SC_CTOR(inOutFunction_mulbkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
