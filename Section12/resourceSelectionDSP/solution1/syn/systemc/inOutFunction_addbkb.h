...
// ==============================================================
#ifndef __inOutFunction_addbkb__HH__
#define __inOutFunction_addbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inOutFunction_addbkb) {
    ...
    SC_CTOR(inOutFunction_addbkb):  ACMP_add_comb_U ("ACMP_add_comb_U") {
